...
#m4
m4.logMR.logT.interxn.sesh.usall <- mclapply(1:3, function(i) {
  MCMCglmm(cbind(t_22, t_24, t_26, t_28, t_30, t_32) ~  trait - 1 + trait:z.log.mass,
           random= ~us(trait):id + us(trait):samp_period,
           rcov = ~us(trait):units,
...
saveRDS(m4.logMR.logT.interxn.sesh.usall , "R/m4.logMR.logT.interxn.sesh.usall")
