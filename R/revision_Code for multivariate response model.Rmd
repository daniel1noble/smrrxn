...
wdata <- data[complete.cases(data[,10:ncol(data)]),]
...
varcomps[7:12,3:6] <- posterior_summary(cs_mvmod_mi, "^sd_series") 
...
ggplot(data = rpt.plot.dat, aes(x = Temp, y = Mean)) +
