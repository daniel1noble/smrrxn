...
predictors <- c("log.temp_22cen", "z.log.mass", "id", "series")
...
#22 centered
m1.logMR.logT.npT.t22 <- mclapply(1:3, function(i) {
  MCMCglmm(log.co2pmin ~ log.temp_22cen + z.log.mass,
  ...
  saveRDS(m1.logMR.logT.npT.t22, "R/m1.logMR.logT.npT.t22")
