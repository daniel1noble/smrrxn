...
#m1.logMR.logT.nopT - prior temp removed
m1.logMR.logT.nopT.BLUP <- mclapply(1:3, function(i) {
  MCMCglmm(log.co2pmin ~ log.temp + z.log.mass,
...
saveRDS(m1.logMR.logT.nopT.BLUP, "R/m1.logMR.logT.nopT.BLUP")
