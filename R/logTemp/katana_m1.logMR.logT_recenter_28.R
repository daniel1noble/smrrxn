...
predictors <- c("log.temp_28cen", "z.log.mass", "id", "series")
...
m1.logMR.logT.npT.t28 <- mclapply(1:3, function(i) {
    MCMCglmm(log.co2pmin ~ log.temp_28cen + z.log.mass,
  ...
  saveRDS(m1.logMR.logT.npT.t28, "R/m1.logMR.logT.npT.t28")
