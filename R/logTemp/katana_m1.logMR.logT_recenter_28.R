...
predictors <- c("log.temp_28cen", "z.log.mass", "id", "series", "log.prior_temp1")
...
m1.logMR.logT.t28 <- mclapply(1:3, function(i) {
    MCMCglmm(log.co2pmin ~ log.temp_28cen + z.log.mass + log.prior_temp1,
  ...
  saveRDS(m1.logMR.logT.t28, "R/m1.logMR.logT.t28")
