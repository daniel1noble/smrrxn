...
predictors <- c("log.temp_26cen", "z.log.mass", "id", "series")
...
#26 centered
m1.logMR.logT.npT.t26 <- mclapply(1:3, function(i) {
    MCMCglmm(log.co2pmin ~ log.temp_26cen + z.log.mass,
  ...
  saveRDS(m1.logMR.logT.npT.t26, "R/m1.logMR.logT.npT.t26")
