...
predictors <- c("log.co2pmin", "log.temp", "z.log.mass", "log.prior_temp2", "id", "series", "samp_period")
...
#m1.logMR.logT - tests if prior temp is useful or not
m1.logMR.logT <- mclapply(1:3, function(i) {
  MCMCglmm(log.co2pmin ~ log.temp + z.log.mass + log.prior_temp2,
...
saveRDS(m1.logMR.logT, "R/m1.logMR.logT")
