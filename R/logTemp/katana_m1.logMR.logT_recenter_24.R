...
predictors <- c("log.temp_24cen", "z.log.mass", "id", "series", "log.prior_temp1")
...
#24 centered
m1.logMR.logT.t24 <- mclapply(1:3, function(i) {
    MCMCglmm(log.co2pmin ~ log.temp_24cen + z.log.mass + log.prior_temp1,
  ...
  saveRDS(m1.logMR.logT.t24, "R/m1.logMR.logT.t24")
