...
```{r}
ms_data <- data %>% 
  select(id, samp_period, incb_temp, log.co2pmin, log.mass) %>%
  group_by(id) %>% 
...
hier.ms.dat <- as.data.frame(matrix(ncol = 5, nrow = 6*3))
colnames(hier.ms.dat) <- c("Temp", "Type", "Est", "Lower", "Upper")
hier.ms.dat$Temp <- rep(seq(22,32, by =2), 3)
hier.ms.dat$Type <- rep(c("Among ID", "Within ID", "Among ID - Within ID"), each = 6)
...
#AmoungID - WithinID
#22C
hier.ms.dat[13,3] <- mean(mod.ms.1.fixed[,7] - mod.ms.1.fixed[,8])
hier.ms.dat[13,4:5] <- HPDinterval(as.mcmc(mod.ms.1.fixed[,7] - mod.ms.1.fixed[,8]))

#24C
hier.ms.dat[14,3] <- mean((mod.ms.1.fixed[,7] + mod.ms.1.fixed[,9]) - (mod.ms.1.fixed[,8] + mod.ms.1.fixed[,14]))
hier.ms.dat[14,4:5] <- HPDinterval(as.mcmc(mod.ms.1.fixed[,7] + mod.ms.1.fixed[,9]) - (mod.ms.1.fixed[,8] + mod.ms.1.fixed[,14]))

#26C
hier.ms.dat[15,3] <- mean((mod.ms.1.fixed[,7] + mod.ms.1.fixed[,10]) - (mod.ms.1.fixed[,8] + mod.ms.1.fixed[,15]))
hier.ms.dat[15,4:5] <- HPDinterval(as.mcmc((mod.ms.1.fixed[,7] + mod.ms.1.fixed[,10]) - (mod.ms.1.fixed[,8] + mod.ms.1.fixed[,15])))

#28
hier.ms.dat[16,3] <- mean((mod.ms.1.fixed[,7] + mod.ms.1.fixed[,11]) - (mod.ms.1.fixed[,8] + mod.ms.1.fixed[,16]))
hier.ms.dat[16,4:5] <- HPDinterval(as.mcmc((mod.ms.1.fixed[,7] + mod.ms.1.fixed[,11]) - (mod.ms.1.fixed[,8] + mod.ms.1.fixed[,16])))

#30
hier.ms.dat[17,3] <- mean((mod.ms.1.fixed[,7] + mod.ms.1.fixed[,12]) - (mod.ms.1.fixed[,8] + mod.ms.1.fixed[,17]))
hier.ms.dat[17,4:5] <- HPDinterval(as.mcmc((mod.ms.1.fixed[,7] + mod.ms.1.fixed[,12]) - (mod.ms.1.fixed[,8] + mod.ms.1.fixed[,17])))

#32
hier.ms.dat[18,3] <- mean((mod.ms.1.fixed[,7] + mod.ms.1.fixed[,13]) - (mod.ms.1.fixed[,8] + mod.ms.1.fixed[,18]))
hier.ms.dat[18,4:5] <- HPDinterval(as.mcmc((mod.ms.1.fixed[,7] + mod.ms.1.fixed[,13]) - (mod.ms.1.fixed[,8] + mod.ms.1.fixed[,18])))
...
hier.ms.dat$Type <- factor(hier.ms.dat$Type, levels(factor(hier.ms.dat$Type))[c(1,3,2)])

 ggplot(data = hier.ms.dat, aes(y = Est, x = Temp)) +
...
data %>% filter(id %in% mysubset) %>%
  ...
  geom_line(aes(group = id), stat="smooth", method = "lm", alpha = 0.3, lwd = 0.5) +
